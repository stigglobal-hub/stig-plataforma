...
export default function AppParceiroDefinitivo() {
  ...
  return (
    <div style={{ backgroundColor: '#000', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', fontFamily: "'Sora', sans-serif" }}>
      ...
      {/* ESTILOS ORIGINAIS DO SEU PROTÓTIPO */}
      ...
      <div className="shell">
        ...
        {activeTab === 'pedidos' && (
          <div className="screen">
            <div className="page-hdr">
              ...
              <button onClick={fetchPedidos} style={{ background: 'var(--card3)', color: 'var(--tx)', border: '.5px solid var(--bd2)', borderRadius: '8px', padding: '6px 12px', fontSize: '10px', cursor: 'pointer' }}>↻ atualizar</button>
            </div>
            ...
            <div style={{ padding: '0 20px' }}>
              {pedidos.length === 0 ? (
                ...
                pedidos.map(p => (
                  <div key={p.id} style={{ background: 'var(--card)', border: '.5px solid var(--bd2)', borderRadius: '16px', padding: '14px', marginBottom: '10px' }}>
        ...
        {activeTab === 'menu' && (
          <div className="screen">
            ...
            <div style={{ padding: '0 20px' }}>
              {menuItems.map(item => (
                <div key={item.id} style={{ background: 'var(--card)', border: '.5px solid var(--bd2)', borderRadius: '14px', padding: '12px 14px', display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '10px' }}>
                  ...
                  <button onClick={() => deleteItem(item.id)} style={{ background: 'transparent', border: 'none', color: 'var(--tx
